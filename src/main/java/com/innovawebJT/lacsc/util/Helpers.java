	...
	public static UserResponseDTO mapToUserResponseDTO(User user, SummaryCounterDTO summaryCounter, CourseCounterDTO courseCounter) {
		return UserResponseDTO.builder()
				...
				.institution(InstitutionDTO.builder()
						.institutionName(user.getInstitution().getInstitutionName())
						.institutionAcronym(user.getInstitution().getInstitutionAcronym())
						.institutionCountry(user.getInstitution().getInstitutionCountry())
						.build())
